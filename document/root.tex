...
%%MKL I dont understand the following sentence:  @MW 
...
\end{figure*}
%%MKL: spomina sa tu correlation analysis, preco? Ved v clanku sa nikde nevyuzije, ci?  @MW 
...
%%MKL: toto je velmi divny odstavec. Ak ho tu chceme mat, tak treba jasne napisat co ktora kapitola robi. Odbit to v zavere paragrafu, ze "the following sections..." je velmi nejasne.  @MW 
...
%%MKL: spominaju sa tu matice a nieje jasne v akom matematickom kontexte. CHyba mi tu rovnica, ktora zadefinuje je ze co je vlastne matica \(\mathcal{K}\)  @MW
...
%%MKL: zacinat odstavec skratkou nieje idealne, najme ak skratka zacina malym pismenom. Radsej cele vypisat.  @MW
...
%%MKL: 1. co je eDMD with a without sqrt? Odkial toto prislo?  @MW
...
%%MKL: dobre a aky je zaver z tejto analyzy?  @MW
...
\begin{figure}[htbp]\label{fig:two_tanks_eigs}
    %%MKL: treba rozbit na jednotlive subfigures, aby bolo jasne, co je co a dalo sa to referencovat v clanku.  @MW
