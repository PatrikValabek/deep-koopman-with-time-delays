...
%%MKL I dont understand the following sentence:
...
\end{figure*}
%%MKL: spomina sa tu correlation analysis, preco? Ved v clanku sa nikde nevyuzije, ci?
...
%%MKL: toto je velmi divny odstavec. Ak ho tu chceme mat, tak treba jasne napisat co ktora kapitola robi. Odbit to v zavere paragrafu, ze "the following sections..." je velmi nejasne.
...
%%MKL: spominaju sa tu matice a nieje jasne v akom matematickom kontexte. CHyba mi tu rovnica, ktora zadefinuje je ze co je vlastne matica \(\mathcal{K}\)
...
%%MKL: toto vyzera skor ako promo na NeuroMANCER, nez ako popis implementacie. Tu treba zvyraznit, ktore funkcionality z neho vyuzivame.
...
%%MKL: x_k nieje definovane, co to reprezetuje? Ktory system?
...
\begin{subequations}
    ...
    \end{align}
\end{subequations}
%%MK: kazdy chape prediction horizon N ako pocet krokov predikcie v MPC riadeni. Je to to iste? LEbo mam pocit, ze tu je to skor pocet krokov pri trenovani Koopman modelu, cize moze vzniknut confusion.
...
%%MKL: tu mi chyba nejaky zaver, preco sa bavime of tychto loss-och? Akym sposobom to vplyva na vysledky? nejaky section-ending, ktory "namotivuje" naco som to cele cital, smerom do druhej kapitioly.
\section{Results}
...
%%MKL: zacinat odstavec skratkou nieje idealne, najme ak skratka zacina malym pismenom. Radsej cele vypisat.
...
%%MKL: 1. co je eDMD with a without sqrt? Odkial toto prislo? 2. Tie cisla treba naskalovat na %, t.j. z niektorej metriky treba spravit 100% resp. 1, a ostatne podla toho prepocitat. Chyba mi zaver z tejto tabulky. Co sme dosiahli?
...
%%MKL: dobre a aky je zaver z tejto analyzy? 
...
\begin{figure}[htbp]\label{fig:two_tanks_eigs}
    %%MKL: treba rozbit na jednotlive subfigures, aby bolo jasne, co je co a dalo sa to referencovat v clanku.
...
\section{Conclusion}
%%MKL: je treba v zavere spomenut v com presne nas clanok priniesol novelty a konkretne povedat, nejakou metrikou, o co sme lepsi ako nejaka ina metoda.
