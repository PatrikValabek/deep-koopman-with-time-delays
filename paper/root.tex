...
\begin{table}[htbp]\label{tab:results:two_tanks_results}
    \caption{Performance comparison of LSTM-enhanced Deep Koopman, DKO and eDMD on the two tank system with input delays}
    \begin{center}
        \begin{tabular}{c S[table-format=1.4]  S[table-format=1.4] S[table-format=1.3]}
            \toprule
            \textbf{Model}             & \textbf{MAE}~\([m]\) & \textbf{RMSE}~\([m^\mathrm{2}]\) & \textbf{R\textsuperscript{2}} \\
            \midrule
            DKO                        & 0.044                & 0.127                            & 0.989                         \\
            LSTM-enhanced Deep Koopman & 0.045                & 0.127                            & 0.989                         \\
            eDMD (known dynamics)      & 0.014                & 0.087                            & 0.994                         \\
            eDMD (unknown dynamics)    & 0.016                & 0.083                            & 0.995                         \\
            \bottomrule
        \end{tabular}
    \end{center}
\end{table}
...
\begin{figure}[htbp]\label{fig:results:two_tanks_eigs}
    ...
    \caption{Comparison of eigenvalues of the Koopman operator for the two tank system. Red is the most dominant eigenvalue, green is the second most dominant eigenvalue, and orange are the rest of the eigenvalues. In all the cases, all the eigenvalues are stable. The true eigenvalues of the system are given for linearization around mean water levels.}
\end{figure}
